...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--clip-pretrained", default="laion2b_s34b_b79k")
    ...
    run.add_argument("--clip-cache-dir", default=None, help="Optional writable cache dir for OpenAI CLIP weights")
    run.add_argument("--dinov2-model", default="facebook/dinov2-base")
