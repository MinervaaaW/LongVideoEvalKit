...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--enable-paper-metrics", action="store_true", help="Enable exact paper-style metrics")
    run.add_argument("--paper-quality-clip-seconds", type=float, default=None, help="Clip length for exact first/last quality drift")
    run.add_argument("--paper-cf-window-radius-seconds", type=float, default=None, help="Half-window radius for Context Forcing DINOv2 scoring")
